...
export async function clientAction({ request }: Route.ClientActionArgs): Promise<ActionProps> {
  ...
  try {
    const respons = await fetch('http://127.0.0.1:3031/api/auth/login', {
      method: 'POST',
      headers: {
